package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1113:String = "increment";
      
      private static const const_497:String = "slider_bar";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_497:
               if(param2.type == WindowNotifyEvent.const_270)
               {
                  if(!var_602)
                  {
                     if(_horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_379)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return track.findChildByName(ScrollbarController.const_497) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_898 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_898 != null)
         {
            _loc1_ = findParentByName(var_898) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_898) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1113)
            {
               if(var_21)
               {
                  var_602 = true;
            ...
            else if(param2.name == ScrollbarController.const_784)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_497).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_821)
         {
