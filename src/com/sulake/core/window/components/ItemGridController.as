package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      public function getGridItemIndex(param1:IWindow) : int
      {
         ...
         return _loc2_.getListItemIndex(param1) * method_1 + getColumnIndex(_loc2_);
      }
      
      protected function addColumnForItem(param1:IWindow) : IItemListWindow
      {
         var _loc2_:IItemListWindow = _context.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_298,WindowStyle.const_330,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),listEventProc,null,numListItems,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IItemListWindow;
      ...
      protected function offsetGridItemsForwards(param1:IWindow, param2:uint) : void
      {
         ...
         else
         {
            ...
            resolveColumnByIndex(param2).addListItemAt(param1,param2 / method_1);
         }
         var _loc10_:* = 0;
         _loc9_ = 0;
         while(_loc9_ < _loc6_)
      ...
      protected function resolveColumnForNextItem(param1:IWindow) : IItemListWindow
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            _loc6_ = _loc5_ > -1 ? _loc5_ == method_1 - 1 : true;
            if(_loc6_)
            {
      ...
      public function get method_1() : uint
      {
         return numListItems;
      }
      ...
      {
         return getListItemAt(param1 % method_1) as IItemListWindow;
      }
