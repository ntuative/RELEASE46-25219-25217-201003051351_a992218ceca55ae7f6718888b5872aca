package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1386:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_432 = new Array();
         var_432[0] = MouseCursorType.const_300;
         var_432[1] = MouseCursorType.const_36;
         var_432[2] = MouseCursorType.const_300;
         var_432[3] = MouseCursorType.const_300;
         var_432[4] = MouseCursorType.const_36;
         var_432[5] = MouseCursorType.const_36;
         var_432[6] = MouseCursorType.const_300;
         if(var_320 == null)
         {
            var_320 = new Array();
      ...
      {
         param2.push(new PropertyStruct(const_1024,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_738));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_1008,param1.toolTipDelay != const_1386));
         return param2;
      }
