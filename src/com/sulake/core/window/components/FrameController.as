package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1067:String = "_HEADER";
      ...
      private static const const_1066:String = "_CONTENT";
      ...
      private var var_1213:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_750,_loc3_.left,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_753,_loc3_.top,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_752,0 - _loc3_.right,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_751,0 - _loc3_.bottom,PropertyStruct.const_60,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_258);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_216);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_215);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_216,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_216,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1213 == null)
         {
            var_1213 = findChildByTag(const_1067) as IHeaderWindow;
            if(!var_1213)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_229,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1066) as IWindowContainer;
            if(!var_20)
            {
