package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_907:IItemListWindow;
      
      private var var_357:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_357)
         {
            var_357 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_357)
            {
               var_357.addEventListener(WindowEvent.const_238,scrollBarEventProc);
               var_357.addEventListener(WindowEvent.const_212,scrollBarEventProc);
            }
         }
         return var_357;
      }
      ...
      override public function dispose() : void
      {
         if(var_357)
         {
            var_357.removeEventListener(WindowEvent.const_238,scrollBarEventProc);
            var_357.removeEventListener(WindowEvent.const_212,scrollBarEventProc);
            var_357 = null;
         }
         if(var_907)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_212)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_907)
         {
            var_907 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_907;
      }
