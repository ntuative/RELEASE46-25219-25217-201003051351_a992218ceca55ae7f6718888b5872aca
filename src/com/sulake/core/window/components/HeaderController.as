package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const CONTROLS_ELEMENT_TAG:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.TITLE_ELEMENT_TAG) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.CONTROLS_ELEMENT_TAG) as IItemListWindow;
      }
   }
}
