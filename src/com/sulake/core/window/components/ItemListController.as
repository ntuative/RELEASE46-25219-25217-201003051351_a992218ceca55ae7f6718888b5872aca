package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1384:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_162 = var_744 || !testParamFlag(WindowParam.const_31);
         _container = _context.create("_CONTAINER","",WindowType.const_331,WindowStyle.const_330,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_321,containerEventHandler);
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_321,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1022,var_741,PropertyStruct.const_56,var_741 != const_1383));
         _loc1_.push(new PropertyStruct(const_1020,var_524,PropertyStruct.const_56,var_524 != const_1384));
         _loc1_.push(new PropertyStruct(const_1021,var_1093,PropertyStruct.const_56,var_1093 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_468,param1);
            }
            else
            {
