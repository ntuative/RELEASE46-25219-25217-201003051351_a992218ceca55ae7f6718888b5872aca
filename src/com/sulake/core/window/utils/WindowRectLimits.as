package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_391:int = -2147483648;
      ...
      {
         return var_391 == int.MIN_VALUE && var_388 == int.MAX_VALUE && var_390 == int.MIN_VALUE && var_389 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_388 = param1;
         if(var_388 < int.MAX_VALUE && true && _target.width > var_388)
         {
      ...
      {
         var_391 = param1;
         if(var_391 > int.MIN_VALUE && true && _target.width < var_391)
         {
