package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1009:String = "_EXCLUDE";
      
      public static const const_1509:String = "_TEMP";
      
      private static const const_1090:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1091:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1103:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_928:Dictionary;
      
      protected var var_1373:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1374:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1103 = new Dictionary();
         TypeCodeTable.fillTables(var_1102,var_1103);
         var_928 = new Dictionary();
         var_1374 = new Dictionary();
         ParamCodeTable.fillTables(var_928,var_1374);
         var_1373 = new Map();
      }
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1090,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1103)
            {
               delete var_1103[_loc1_];
            }
            for(_loc1_ in var_928)
            {
               delete var_928[_loc1_];
            }
            for(_loc1_ in var_1374)
            {
               delete var_1374[_loc1_];
            }
            var_1373.dispose();
            var_1373 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1009) == -1)
                  {
