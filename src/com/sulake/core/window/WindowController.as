package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _children = new Array();
         var_311 = new Rectangle();
         if(_loc12_ != null)
         {
            var_363 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_54 = var_363.clone();
            var_5 = var_363.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_107,WindowParam.const_138);
         var _loc2_:* = !testParamFlag(WindowParam.const_110,WindowParam.const_133);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_14 & 0);
               if(_loc5_ == WindowParam.const_231)
               {
      ...
      {
         var_744 = param1;
         var_615 = !!var_744 ? uint(var_615 | var_1371) : uint(var_615 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2221 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_949:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_270:
               _loc2_ = "null";
               break;
      ...
      public function method_11(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_81 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_474,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_680,var_5);
            var_16.visible = var_358;
         }
         return var_16;
      }
      ...
      {
         var_1371 = param1 & 4278190080;
         var_615 = !!var_744 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_69);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_655))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_882;
                  if(testParamFlag(WindowParam.const_281))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_191))
                        {
                  ...
                  if((var_14 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_258))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_191))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_217:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_384,this,null));
                     if(testParamFlag(WindowParam.const_159,WindowParam.const_138))
                     {
                     ...
                     if(var_6 != null)
                     {
                        ...
                        var_14 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_249,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_442:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_451);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_949,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_270,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_304:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_506,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_211,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_367:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_824);
                  break;
               case WindowNotifyEvent.const_474:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_444:
                  if(!(var_14 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_451);
                     }
                  }
                  else if(var_14 & 0)
                  {
               ...
               case WindowNotifyEvent.const_211:
                  ...
                  break;
               case WindowNotifyEvent.const_384:
                  var_6.getRegionProperties(null,var_311);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_327:
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_639,this,param1));
         return param1;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_418)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_529,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_217,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_63,true);
         _loc1_.type = WindowNotifyEvent.const_1371;
         update(this,_loc1_);
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1320,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_63,false);
         _loc1_.type = WindowNotifyEvent.const_1304;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_311 = var_6.rectangle.clone();
               var_54.x = var_5.x;
               var_54.y = var_5.y;
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_379,this,var_6));
            }
            else
            {
               var_311.x = 0;
               ...
               var_311.width = 0;
               var_311.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_929,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_14,_context,var_5,null,var_617,properties,var_616.concat(),_id) as WindowController;
         _loc2_.var_746 = var_746;
         _loc2_.var_162 = var_162;
         _loc2_._debug = _debug;
         _loc2_.var_311 = var_311.clone();
         _loc2_.var_5 = var_5.clone();
         _loc2_.var_363 = var_363.clone();
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_523;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_32 == WindowState.const_465)
         {
            return true;
         }
         var_32 = WindowState.const_465;
