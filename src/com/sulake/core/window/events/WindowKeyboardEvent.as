package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_136:String = "WKE_KEY_DOWN";
      
      public static const const_659:String = "WKE_KEY_UP";
       
      
      private var var_697:KeyboardEvent;
      ...
      {
         _type = param1;
         var_697 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get keyLocation() : uint
      {
         return var_697.keyLocation;
      }
      
      public function get shiftKey() : Boolean
      {
         return var_697.shiftKey;
      }
      
      public function get charCode() : uint
      {
         return var_697.charCode;
      }
      
      public function get keyCode() : uint
      {
         return var_697.keyCode;
      }
      
      public function get altKey() : Boolean
      {
         return var_697.altKey;
      }
      ...
      {
         return new WindowKeyboardEvent(_type,var_697,window,related,bubbles,cancelable);
      }
   }
}
