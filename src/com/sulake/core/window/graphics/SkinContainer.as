package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1101:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2170 = new Dictionary();
         TypeCodeTable.fillTables(var_1553,var_2170);
         var_1324 = new Dictionary();
         var_2169 = new Dictionary();
         StateCodeTable.fillTables(var_1324,var_2169);
         var_511 = new Dictionary();
         var_511["skin"] = BitmapSkinRenderer;
         var_511["bitmap"] = BitmapDataRenderer;
         var_511["fill"] = FillSkinRenderer;
         var_511["text"] = TextSkinRenderer;
         var_511["shape"] = ShapeSkinRenderer;
         var_511["unknown"] = SkinRenderer;
         var_511["null"] = NullSkinRenderer;
         if(var_367 == null)
         {
            var_367 = new Array();
            var_367.push(WindowState.const_63);
            var_367.push(WindowState.const_65);
            var_367.push(WindowState.const_91);
            var_367.push(WindowState.const_45);
            var_367.push(WindowState.const_73);
            var_367.push(WindowState.const_70);
            var_367.push(WindowState.const_90);
            var_367.push(WindowState.const_81);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1324)
         {
            _loc3_.push(var_1324[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1553[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_597[param1] = new Array(SkinContainer.const_1101);
         }
         var_597[param1][param2] = param3;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_597)
         {
            ISkinRenderer(var_597[_loc1_]).dispose();
            delete var_597[_loc1_];
         }
