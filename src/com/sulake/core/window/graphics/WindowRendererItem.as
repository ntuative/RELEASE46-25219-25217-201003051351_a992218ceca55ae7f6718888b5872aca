package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_694:ISkinContainer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_824:
               var_695 = var_694.getTheActualState(param1.type,param1.style,param1.state);
               if(var_695 != var_1037)
               {
                  var_229 = true;
                  _loc4_ = true;
      ...
      {
         return var_694.getTheActualState(param1.type,param1.style,param1.state) != var_1037;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_765) : uint(const_486);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_695) ? uint(const_764) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_764)
               {
                  ...
                  if(var_229)
                  {
                     ...
                     _loc6_.draw(param1,var_95,var_95.rect,var_695,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_31))
                  {
                     ...
                     _loc4_.draw(var_95,var_923,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_694.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_936)
            {
               _loc2_ = var_694.getSkinRendererByType(param1.type,WindowStyle.const_936);
            }
         }
         return _loc2_;
      }
