package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_955:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_538:uint = 0;
      
      public static const const_800:String = "AssetLibraryReady";
      
      public static const const_1294:String = "AssetLibraryUnloaded";
      
      public static const const_354:String = "AssetLibraryLoaded";
      
      public static const const_1271:String = "AssetLibraryLoadError";
      ...
      private var var_451:Boolean = true;
      
      private var var_328:Class;
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_632)
         {
            delete var_632[_loc1_];
         }
         if(var_15 != null)
         {
            var_15.dispose();
         ...
         var_288 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1294));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_328 = _loc2_.resource;
         if(var_451)
         {
            AssetLibrary.fetchLibraryContents(this,var_452,var_328);
         }
         var_288 = true;
         dispatchEvent(new Event(AssetLibrary.const_354));
         dispatchEvent(new Event(AssetLibrary.const_800));
         if(var_451)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_982,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_955.splice(var_955.indexOf(this),1);
            --var_538;
            var_369 = null;
            var_632 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_327.length ? getAssetByName(var_327[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1271));
      }
      ...
      {
         var _loc2_:Class = var_632[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_328[param1]);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_327.splice(var_327.indexOf(_loc2_),1);
      ...
      {
         return var_328 != null ? false : false;
      }
   }
}
