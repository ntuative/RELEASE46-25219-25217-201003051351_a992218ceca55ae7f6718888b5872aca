package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1088:Number = 90;
      
      private static const const_740:int = 50;
      
      private static const const_1038:Number = 25;
      
      private static const const_1039:int = 50;
      ...
      private var var_942:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_942 = param2;
         var_535 = new Timer(const_1038);
         var_535.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_443.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_443.splice(_loc3_,1);
            var_442.splice(_loc3_,1);
         }
         var_442.push(param1.name);
         var_443.push(param2);
         param1.addEventListener(WindowEvent.const_470,windowEventListener);
         param1.addEventListener(WindowEvent.const_212,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_443[var_442.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_942.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_287.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_287.splice(var_287.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_942.getIconLoc(param1.iconId);
      ...
      {
         return var_442[var_443.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_287[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_536[_loc3_] = new Array();
            }
            if(var_536[_loc3_].indexOf(param1) < 0)
            {
               var_536[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_740 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_740 || param1.desktop.height - param1.y < const_1039;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_442[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_536[_loc3_].length)
                  {
                     repositionWindow(var_536[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
