package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_183 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_868,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_938 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_938)
         {
         ...
         var_1111 = _loc7_.toolbar.@margin_bottom;
         var_1383 = _loc7_.toolbar.@min_group_margin;
         var_1382 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_243,param1,param2,_window,var_268);
         createGroupsFromXmlList(_loc9_,var_531,param1,param2,var_183,var_268);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_243.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_531.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_120,var_438,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1383,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1111) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1383,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1111) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_120,var_438);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_438);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_120,var_438);
         }
      }
