package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_769:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1085:String = "tile_cursor";
      
      private static const const_274:int = -1;
       
      
      private var var_400:IRoomObjectVisualizationFactory = null;
      ...
      private var var_588:NumberBank;
      ...
      private var var_705:RoomMessageHandler = null;
      
      private var var_704:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_307 = new Map();
         var_588 = new NumberBank(1000);
         var_1051 = new Map();
         var_308 = new Map();
         var_65 = new RoomObjectEventHandler(this);
         var_705 = new RoomMessageHandler(this);
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_692) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_698) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_599) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_629) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_148);
            if(_loc7_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_400 != null)
         {
            var_400.release(new IIDRoomObjectVisualizationFactory());
            var_400 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_704 != null)
         {
            var_704.release(new IIDRoomRendererFactory());
            var_704 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_704.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_849;
         ...
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_726);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_593);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_803);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_920);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_968) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_945);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_446,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_516,var_116,var_115,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_308.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_308.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_729,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_604,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            ...
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_228);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_59);
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_198,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_303,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_302,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_869,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_897,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      {
         if(var_25 == null || var_400 == null || var_41 == null || var_704 == null || _communication == null || var_97 == null || !var_2115)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_274,RoomObjectCategoryEnum.const_59);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1197,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_116,var_115));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_770,RoomObjectCategoryEnum.const_228);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_115,var_1291);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_115,var_1291);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_400 = param2 as IRoomObjectVisualizationFactory;
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_400;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_25 != null)
         {
            if(false)
            {
               var_25.events.addEventListener(RoomObjectMouseEvent.const_214,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_447,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_372,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_269,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_606,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_115,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_368,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_473,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_365,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_440,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_358,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_392,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_401,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_448,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectMoveEvent.const_375,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_380,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_248,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_471,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_326,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_319,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_373,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_847,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_400,roomObjectEventHandler);
               var_25.events.addEventListener(AvatarWalkWarpingWarningEvent.const_406,warningEventHandler);
            }
         }
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_308.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_198));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_411);
                     break;
                  case RoomObjectCategoryEnum.const_34:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_156);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_310);
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_198,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_303,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_302,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_849,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_387,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_769) as Sprite;
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_704 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_41.getRoom(const_488);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_488,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_588.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_29:
            case RoomObjectCategoryEnum.const_28:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_198,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_411,param8);
               break;
            case RoomObjectCategoryEnum.const_34:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_156,param2);
               break;
            case RoomObjectCategoryEnum.const_59:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_131,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_132,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_132,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_537,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_653,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_699,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_446,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1051.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_860,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_588.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_768,RoomObjectCategoryEnum.const_228);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1538 - _loc12_.width / 2;
               _loc11_.y = var_1537 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_449,var_116,var_115,-1,RoomObjectCategoryEnum.const_207));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_274,const_487);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_115,var_1291);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1538 - _loc6_.data.width / 2;
               _loc11_.y = var_1537 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_322,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1016,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1013,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_808,RoomObjectVariableEnum.const_322,param1.clickUrl);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_488);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_860);
               ...
               var_588.freeNumber(_loc10_ - 1);
               _loc13_ = var_1051.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_116,var_115,const_274,RoomObjectCategoryEnum.const_59,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_988,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_706,1,true);
            _loc13_ = parseInt(var_97.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_998,_loc13_,true);
            if(var_9 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_274,const_487,_loc8_) as IRoomObjectController;
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_692,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_599,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_698,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_629,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_985,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_729,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_604,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_446,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_186);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_726,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_593,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_726,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_593,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_803,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_920,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_768,const_1085,RoomObjectCategoryEnum.const_228);
         _loc7_.createRoomObject(const_770,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_228);
         return _loc7_;
      }
