package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < var_140 && param2 >= 0 && param2 < var_141)
         {
            _loc3_ = var_877[param2] as Array;
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param1 + param3 > var_140 || param2 + param4 > var_141)
         {
            return false;
         }
         ...
         if(param6 + param8 >= var_141)
         {
            param8 = var_141 - param6;
         }
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:* = null;
      ...
      public function setIsRoomTile(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < var_140 && param2 >= 0 && param2 < var_141)
         {
            _loc4_ = var_877[param2] as Array;
            _loc4_[param1] = param3;
            if(!param3)
            {
