package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_864;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_132,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_271,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_788);
         addPlane(RoomPlaneData.const_132,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_132,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_109) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_132,Vector3d.sum(param1,Vector3d.product(param3,-var_109 / param3.length)),Vector3d.product(param3,(param3.length + var_109) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_788 / param2.length);
               addPlane(RoomPlaneData.const_132,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_735 = getFloorHeight(var_103);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_336 || param1 == var_334)
               {
                  _loc5_ = false;
                  _loc6_ = var_335;
                  while(_loc6_ < var_333)
                  {
               ...
               if(param2 == var_335 || param2 == var_333)
               {
                  _loc7_ = false;
                  _loc8_ = var_336;
                  while(_loc8_ < var_334)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_131,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_131,_loc13_,new Vector3d(0,0,-var_109),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_131,_loc13_,new Vector3d(0,0,-var_109),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_131,_loc13_,new Vector3d(0,0,-var_109),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_131,_loc13_,new Vector3d(0,0,-var_109),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
