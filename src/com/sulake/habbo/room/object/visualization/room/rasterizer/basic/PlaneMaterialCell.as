package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_460:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_460 != null)
         {
            _loc2_ = var_460.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  ...
                  _loc3_ = Math.min(var_970,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_970,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_970,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_641[_loc6_ % 0] as IGraphicAsset;
