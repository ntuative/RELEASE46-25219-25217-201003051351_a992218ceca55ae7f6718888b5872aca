package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      private var var_725:PlaneMaskVisualization = null;
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            var_725 = var_426.getValue(String(_sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            var_725 = null;
      ...
      public function createMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         var_426.add(String(param1),_loc2_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc2_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_426 != null)
         {
            ...
            {
               _loc1_ = var_426.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
