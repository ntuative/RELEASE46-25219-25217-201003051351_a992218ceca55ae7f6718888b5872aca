package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class FloorRasterizer extends PlaneRasterizer
   {
      ...
      private function parseFloors(param1:XML) : void
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               if(var_359.getValue(_loc5_) == null)
               {
                  var_359.add(_loc5_,_loc7_);
               }
               else
               {
                  _loc7_.dispose();
      ...
      {
         var _loc13_:FloorPlane = var_359.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_359.getValue(const_739);
         }
         if(_loc13_ == null)
         {
            return null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_359 != null)
         {
            ...
            {
               _loc2_ = var_359.getWithIndex(_loc1_) as FloorPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
