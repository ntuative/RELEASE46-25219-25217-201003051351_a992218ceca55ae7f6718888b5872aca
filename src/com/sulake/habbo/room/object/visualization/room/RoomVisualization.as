package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1100:int = 16777215;
      
      public static const const_1213:int = 10066329;
      
      private static const const_1099:int = 13421772;
      
      public static const const_1308:int = 16777215;
      
      private static const const_1421:int = 0;
      
      public static const const_1265:int = 16777215;
      
      private static const const_1097:int = 10066329;
      
      private static const const_1098:int = 10066329;
      
      public static const const_1176:int = 13421772;
      ...
      private var var_1599:int = -1000;
      
      private var var_1067:uint = 16777215;
      ...
      private const const_1622:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_932);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_985);
         var _loc7_:int = 0;
         while(_loc7_ < var_79.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_131)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_132)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_241,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_241 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_424.maskCount)
         {
            _loc6_ = var_424.getMaskType(_loc5_);
            _loc7_ = var_424.getMaskLocation(_loc5_);
            _loc8_ = var_424.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_102.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_241 || _loc3_.type == RoomPlane.const_177 && _loc8_ == RoomPlaneBitmapMaskData.const_186)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1475;
                        if(var_79.getPlaneType(_loc9_) == RoomPlaneData.const_131)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1259)
         {
            var_1259 = param1.updateId;
            var_595 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_1034 || _loc9_.y != var_2023 || _loc9_.z != var_2022 || param1.scale != var_2024))
            {
               var_1034 = _loc9_.x;
               var_2023 = _loc9_.y;
               var_2022 = _loc9_.z;
               var_2024 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_995);
            if(_loc10_ != var_2166)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_595));
            if(_loc11_ != var_1067)
            {
               var_1067 = _loc11_;
               var_2165 = var_1067 & 255;
               var_2163 = var_1067 >> 8 & 255;
               var_2167 = var_1067 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1599 + const_1622 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1599 = _loc7_;
         if(var_161 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_653);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_537);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_699);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2164 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_973));
         ...
         while(_loc8_ < var_423.length)
         {
            ...
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_177)
            {
               if(var_2164)
               {
                  ...
                  _loc19_ = uint((_loc18_ & 255) * var_2165 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2163 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2167 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_102.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_241 && param2 != null)
               {
                  _loc5_.id = param2;
               }
