package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1141:int = const_285;
      ...
      public static const const_589:int = 6;
      
      public static const const_247:int = const_97;
      ...
      private var var_817:Vector3d = null;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1695 = param6;
         var_1696 = param7;
         var_817 = new Vector3d();
         if(var_1451 == const_589)
         {
            var_1266 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1506 == const_97)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_495);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_495,var_26.width,var_495);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_817,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_495,param6,param7);
                     return param1;
                  }
                  return var_26;
               }
