package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1407:int = 0;
      ...
      private const const_1077:int = 3;
      
      private const const_1612:int = 2;
      
      private var var_832:AvatarVisualizationData = null;
      ...
      {
         var_832 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_156);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_705);
         ...
         var _loc14_:Number = _loc8_ - var_1261;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_328);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_282 != _loc3_.getUpdateID() || var_207 != param1.scale || var_161 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_494 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_494;
            ...
            if(_loc6_ == null)
            {
               _loc6_ = var_832.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_310);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_246) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_246);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_638);
            _loc6_.appendAction(AvatarAction.const_654,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_348);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_361);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_287,AvatarAction.const_1277[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_794);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_870,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_884);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_943);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_913,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_543);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_686);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_789,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_828);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_853,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_454);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_441) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_600);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_408);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_835);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_723,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_930))
            {
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_832.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_833.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_833)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
