package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_904);
      ...
      {
         if(param1 < var_566.length)
         {
            return var_566[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_224 != null)
         {
            ...
            {
               _loc2_ = var_224[_loc3_];
               _loc2_.update(var_566,var_1962,param1);
               _loc3_++;
            }
