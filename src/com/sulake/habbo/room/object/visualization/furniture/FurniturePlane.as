   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2021)
         {
            if(!param1)
            {
               var_261.assign(var_577);
               var_262.assign(var_578);
            }
            else
            {
               var_261.assign(var_577);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_74 == null && var_783 != null || var_261 == null || var_262 == null || var_459 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1259)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1034 || _loc4_.y != var_2023 || _loc4_.z != var_2022 || param1.scale != var_2024))
            {
               var_1034 = _loc4_.x;
               var_2023 = _loc4_.y;
               var_2022 = _loc4_.z;
