package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1258 / 2) % 360 / var_1258;
         ...
         {
            _loc6_ = int(var_227.getKey(_loc5_)) * var_1258;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_946);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_983);
                  break;
               case "DARKEN":
