package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1450:String = null;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1450 != null && var_1450.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_946:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_983:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_2245 != param1 || var_2246 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_609[_loc3_] = "";
               var_610[_loc3_] = false;
               _loc3_--;
            }
            var_2245 = param1;
            var_2246 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2248 != param1 || var_2247 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2274 = _loc3_.getNumber(RoomObjectVariableEnum.const_198);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_219));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1450 = _loc3_.getString(RoomObjectVariableEnum.const_302);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_282 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2261)
         {
