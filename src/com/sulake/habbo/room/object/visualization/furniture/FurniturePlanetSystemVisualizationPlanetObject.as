package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1128:Number = 30;
      ...
      private var var_739:Vector3d;
      
      private var var_1109:Number;
      
      private var var_2231:Number;
      ...
      {
         var_739 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1109 = param3;
         var_2231 = param4 * 0 * 2 / 360;
      ...
      {
         var _loc3_:Number = var_1109 * Math.cos(var_915 + var_1575);
         var _loc4_:Number = var_1109 * Math.sin(var_915 + var_1575);
         var _loc5_:Number = _height;
         var_739.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_739.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_739.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_739.add(param1);
         }
