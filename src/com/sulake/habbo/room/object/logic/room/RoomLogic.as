package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1498:int = 1500;
      
      private var var_1500:int = 255;
      
      private var var_1499:int = 255;
      
      private var var_1260:uint = 16777215;
      
      private var var_1035:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_729:
                  _loc2_.setString(RoomObjectVariableEnum.const_537,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_710:
                  _loc2_.setString(RoomObjectVariableEnum.const_653,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_604:
                  _loc2_.setString(RoomObjectVariableEnum.const_699,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_446:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_186)
                  {
                     _loc8_ = "null";
                  }
                  var_424.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_502:
                  _loc7_ = var_424.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_424.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_995,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_973,int(_loc5_.bgOnly));
            var_1260 = _color;
            var_1500 = var_1340;
            var_1035 = _loc11_;
            var_1499 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_932,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_595,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1253,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1332,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1149,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_131)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_132 || _loc13_ == RoomPlaneData.const_271)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_848)
         {
            ...
            {
               _loc7_ = var_1260 >> 16 & 255;
               _loc8_ = var_1260 >> 8 & 255;
               _loc9_ = var_1260 & 255;
               _loc10_ = var_1035 >> 16 & 255;
               _loc11_ = var_1035 >> 8 & 255;
               _loc12_ = var_1035 & 255;
               _loc13_ = (_loc2_ - var_848) / var_1498;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1500 + (var_1499 - var_1500) * _loc13_;
               _color = _loc3_;
               var_1340 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_595,_loc3_);
         }
      }
   }
}
