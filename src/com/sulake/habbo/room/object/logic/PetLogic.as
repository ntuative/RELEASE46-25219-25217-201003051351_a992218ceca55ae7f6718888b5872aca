         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               ...
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1227,_loc4_.race);
               }
               ...
               if(param1 is RoomObjectAvatarSleepUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_441,Number(_loc7_.isSleeping));
               }
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  _loc8_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
                  _loc2_.setString(RoomObjectVariableEnum.const_348,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_361,new Date().valueOf());
               }
               ...
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_246,_loc10_.postureType);
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_959,Number(getTimer()));
                  _loc2_.setNumber(RoomObjectVariableEnum.const_987,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
