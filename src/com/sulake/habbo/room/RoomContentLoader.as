package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_494:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_343:String = "place_holder";
      
      private static const const_1093:String = const_343;
      
      private static const const_1415:int = 0;
      
      private static const const_777:int = 1;
      ...
      public function RoomContentLoader()
      {
         ...
         var_2133 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_410 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_29:
                     if(var_509.indexOf(_loc4_) == -1)
                     {
                        var_509.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_28:
                     if(var_507.indexOf(_loc4_) == -1)
                     {
                        var_507.push(_loc4_);
                     }
                     break;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_508.add(_loc10_,_loc11_);
                              if(var_509.indexOf(_loc14_) < 0)
                              {
                                 var_509.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_507.indexOf(_loc14_) < 0)
                              {
                                 var_507.push(_loc14_);
                              }
                           }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_592.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_343,const_494,ROOM_CONTENT,const_779,const_778];
      }
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_161 && _loc5_ != RoomObjectLogicEnum.const_122)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_509.indexOf(param1) >= 0)
         {
            return const_343;
         }
         if(var_507.indexOf(param1) >= 0)
         {
            return const_494;
         }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_593.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2133.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function continueInitilization() : void
      {
         if(var_2137)
         {
            ...
            if(var_1056 != null)
            {
               var_1056.dispatchEvent(new Event(const_574));
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_2136 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2135 = param2.getKey("public.room.dynamic.download.url","");
            var_2134 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_32 = const_777;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_161 && _loc5_ != RoomObjectVisualizationEnum.const_122)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_400.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_354,onContentLoaded);
            _loc6_ = 0;
