package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_637);
         }
         else
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_690));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_643 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1421);
               }
               break;
            case "sounds_on":
               if(var_643 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1424);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1422);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1421);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1423);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1424);
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               _widget.changeView(MeMenuWidget.const_117);
               break;
            default:
