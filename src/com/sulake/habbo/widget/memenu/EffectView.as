package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_763 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_764 = _window.findChildByName("loader_bar");
         if(var_764 != null)
         {
            var_388 = var_764.width;
            var_178.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_763 != null)
         {
            var_763.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_763.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
