package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_790:MeMenuSettingsView;
      ...
      {
         if(param1.type != WindowEvent.const_470)
         {
            return;
         }
         var_790.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_547 != null)
            {
               ...
               var_1425 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1425 * (Number(param1 - var_645) / (var_974 - var_645)));
      }
      ...
      {
         return param1 / var_1425 * (var_974 - var_645) + var_645;
      }
   }
}
