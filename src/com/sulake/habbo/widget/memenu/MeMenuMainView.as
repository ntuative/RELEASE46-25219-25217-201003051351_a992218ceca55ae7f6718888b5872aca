      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_1000);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_792));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_724);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_796));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_240);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_643));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_702);
               break;
            case "news":
               if(false && false)
               {
