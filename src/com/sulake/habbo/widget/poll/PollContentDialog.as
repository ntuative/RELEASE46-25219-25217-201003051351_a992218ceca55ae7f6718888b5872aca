package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function method_4(param1:IWindowContainer, param2:Array) : void
      {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_676[var_1024] as Dictionary;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1024;
         if(var_1024 < var_676.length)
         {
            _loc1_ = var_676[var_1024] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               switch(_loc3_)
               {
                  case 1:
                     ...
                     break;
                  case 2:
                     method_4(_loc4_,_loc1_["selections"]);
                     break;
                  case 3:
