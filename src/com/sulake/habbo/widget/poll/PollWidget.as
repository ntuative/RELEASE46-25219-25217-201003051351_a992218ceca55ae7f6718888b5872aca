package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_118,showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_62,showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_116,showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_118,showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_62,showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_116,showPollContent);
      }
