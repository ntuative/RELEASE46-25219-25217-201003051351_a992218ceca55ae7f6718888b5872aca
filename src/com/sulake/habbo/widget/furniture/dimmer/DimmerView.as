package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_326:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1043,const_1042,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_326 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_326 != null)
         {
            var_326.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_954 = _loc2_.light;
         if(var_326 != null)
         {
            var_326.setValue(var_954);
         }
         var_387 = colors.indexOf(_loc2_.color);
         if(var_450 != null)
         {
            var_450.setSelectedColorIndex(var_387);
         }
