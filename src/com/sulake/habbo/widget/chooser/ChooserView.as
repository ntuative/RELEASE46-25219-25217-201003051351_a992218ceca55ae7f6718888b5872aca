package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1603:uint = 4.282169599E9;
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(var_649 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_649 % 2) ? uint(const_1400) : uint(const_1399);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1603;
            var_649 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1400) : uint(const_1399);
