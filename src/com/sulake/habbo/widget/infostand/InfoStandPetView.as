package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1625:uint = 6710886;
      ...
      private const const_1624:String = "energy";
      
      private var var_1353:Map;
      
      private const const_1628:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1632:uint = 3355443;
      
      private var var_218:IBorderWindow;
      ...
      private const const_1630:uint = 11184810;
      
      private const const_1631:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_218 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_218 != null)
         {
            var_104 = var_218.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_218.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_218.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_104.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_104.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(var_104 == null || var_218 == null || var_60 == null)
         {
            return;
         }
         var_60.width = var_60.scrollableRegion.width;
         var_60.visible = false;
         var_104.height = var_104.scrollableRegion.height;
         var_218.height = NaN;
         _window.width = Math.max(var_218.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1353.getValue(var_669) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function set name(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_104.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_104.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_104.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1631,param1.experience,param1.experienceMax);
         updateStateElement(const_1624,param1.energy,param1.energyMax);
         updateStateElement(const_1628,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_669 = param1.id;
         var_1353.remove(param1.id);
         var_1353.add(param1.id,param1);
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_104.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_425,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1627,const_1626,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1630);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1632);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1625);
         return _loc5_;
      }
