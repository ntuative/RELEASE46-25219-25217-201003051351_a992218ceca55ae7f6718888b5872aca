package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1050:int = 40;
      ...
      private var var_388:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_978 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1812 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1811 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_650 = new Timer(1000,1);
         var_650.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_795 = new Timer(5000,1);
         var_795.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_136,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_470,onWindowMoved);
         var_1179 = true;
         var_128 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1813 = _loc2_.width + const_496 + _loc6_.width + const_1049;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1050,_loc8_.width) + const_496);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_978 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_128 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_388);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_388);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_462);
