package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1658 = param2;
         var_354 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_108,onBadgeImageReady);
         ...
         var_2033 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_354 != null)
         {
            var_354.events.removeEventListener(BadgeImageReadyEvent.const_108,onBadgeImageReady);
            var_354 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_688,var_2033);
               }
               dispose();
               break;
      ...
      private function registerBadgeParameters(param1:String) : void
      {
         ...
         _localizations.registerParameter(param1,"level",var_1658.toString());
         _localizations.registerParameter(param1,"name",var_354.userName);
         _localizations.registerParameter(param1,"realname",var_354.realName);
      }
   }
}
