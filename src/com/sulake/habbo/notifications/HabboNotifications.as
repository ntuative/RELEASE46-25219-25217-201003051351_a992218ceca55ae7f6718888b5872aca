package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1119:String = "badges";
      
      private static const const_1121:String = "pixelbalance";
      
      private static const const_1120:String = "credits";
      ...
      private static const const_1118:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_604:ParkBusDialogManager;
      
      private var var_603:IHabboToolbar;
      ...
      private var var_729:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_899);
         }
         var _loc6_:Map = var_899["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1251);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_729 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_846)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1174);
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1252);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2185)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_663);
            var_2185 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_603)
         {
            var_603.release(new IIDHabboToolbar());
            var_603 = null;
         }
         if(_windowManager)
         {
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_663,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_563.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_954,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_158 || param2.type == WindowEvent.const_561)
         {
            param1.dispose();
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_604 == null)
         {
            var_604 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_604 != null)
         {
            var_604.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1074.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_563.createPetImage(_loc2_.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_354);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc15_ = var_354.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_78)
               {
                  _loc15_ = var_354.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_354.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_663,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_563.createAvatarImage(param2,AvatarScaleType.const_51);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1074.push(_loc8_);
         return var_1074.length;
      }
      ...
      {
         var_603 = IHabboToolbar(param2);
         var_603.events.addEventListener(HabboToolbarEvent.const_80,onHabboToolbarEvent);
      }
      ...
      function method_6(param1:IMessageEvent) : void
      {
         ...
         if(this.var_354.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_807);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_807);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_80)
         {
            ...
            var_428 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_899["styles"],var_899["view"],var_603);
            ...
            _communication.addHabboConnectionMessageEvent(new RespectNotificationMessageEvent(method_6));
            ...
            var_354.events.addEventListener(BadgeImageReadyEvent.const_108,onBadgeImage);
            var_603.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
