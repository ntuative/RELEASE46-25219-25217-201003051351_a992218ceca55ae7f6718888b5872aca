   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_279;
               _loc14_.figure = _loc7_;
               _loc14_.webID = _loc4_;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_925;
               ...
               _loc14_.sex = UserMessageData.const_950;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1140;
         }
         return UserMessageData.const_950;
      }
