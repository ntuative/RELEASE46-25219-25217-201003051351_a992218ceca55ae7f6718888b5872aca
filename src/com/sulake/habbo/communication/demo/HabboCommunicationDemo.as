package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1750:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_97:IHabboConfigurationManager;
      
      private var var_1417:ILogger;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1751)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_637 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_637);
            _loc2_.send(_loc4_);
      ...
      {
         var_968 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_222);
         param1.send(new VersionCheckMessageComposer(401,var_1166,var_1752));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1750);
      ...
      {
         var_637 = var_97.getKey("sso.ticket",null);
         var_1166 = var_97.getKey("flash.client.url","");
         var_1752 = var_97.getKey("external.variables.txt","");
         if(var_168 == null)
         {
         ...
         if(var_637 != null)
         {
            var_70.mode = HabboConnectionType.const_481;
            var_70.initConnection(HabboConnectionType.const_273);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1417 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_664);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1750 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_70.mode)
         {
            case HabboConnectionType.const_481:
               _loc6_ = "";
               ...
               break;
            case HabboConnectionType.const_1327:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1155:
               var_967 = generateRandomHexString(30);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_196);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionEvent.const_96,onRoomSessionEnded);
      }
