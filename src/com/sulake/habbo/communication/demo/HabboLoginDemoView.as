package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_597:String = "InitConnection";
      ...
      private var var_330:HabboCommunicationDemo;
      ...
      {
         var_330.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_330.shockwaveClientUrl = var_108.shockwaveClientUrl;
         var_330.ssoTicket = var_108.ticket;
         var_108.removeEventListener(SSOTicket.const_317,onParsedTicketSuccess);
         var_108.removeEventListener(SSOTicket.const_251,onParsedTicketFailure);
         var_108 = null;
         dispatchEvent(new Event(const_597));
      }
      ...
      {
         var _loc1_:XmlAsset = (var_330 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_330.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_356,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_330.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_87,windowEventProcessor);
         }
         else
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_330.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_330.habboCommunication.habboWebLogin(name,password);
         var_108 = new SSOTicket(var_330.assets,_loc2_,_loc1_);
         var_108.addEventListener(SSOTicket.const_317,onParsedTicketSuccess);
         var_108.addEventListener(SSOTicket.const_251,onParsedTicketFailure);
      }
