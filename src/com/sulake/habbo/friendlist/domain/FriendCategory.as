package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_971:int = 0;
      ...
      {
         return Math.ceil(this.var_210.length / const_284);
      }
      ...
      {
         if(this.var_755 >= this.getPageCount())
         {
            this.var_755 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_755 + 1) * const_284,this.var_210.length);
      }
