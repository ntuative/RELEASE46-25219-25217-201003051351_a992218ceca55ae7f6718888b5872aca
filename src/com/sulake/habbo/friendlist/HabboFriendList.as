package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_172:String = "face";
      ...
      private var var_1438:OpenedToWebPopup;
      
      private var var_800:IAvatarRenderManager;
      ...
      private var var_1439:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_801:FriendRequests;
      
      private var var_1768:int;
      
      var var_13:FriendCategories;
      
      private var var_1824:FriendListLookAndFeel;
      ...
      {
         var_1824 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1439 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_801.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_801.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_396.findTab(FriendListTab.const_82).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_801 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_971,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_437,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_466)
         {
            var_466 = new Timer(120000);
            var_466.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_466.start();
         }
         getBuddyRequests();
         registerListeners();
         var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_466.stop();
            var_466.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_466 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_800)
         {
            var_800.release(new IIDAvatarRenderManager());
            var_800 = null;
         }
         if(var_802)
         {
      ...
      {
         var _loc1_:String = var_172.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1439.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_801.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_396.findTab(FriendListTab.const_82);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_800.createAvatarImage(param1,AvatarScaleType.const_95);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_801.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_396.findTab(FriendListTab.const_82);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_800 = param2 as IAvatarRenderManager;
      ...
      {
         return var_172.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1438 == null)
         {
            var_1438 = new OpenedToWebPopup(this);
         }
         var_1438.show(x,y);
      }
