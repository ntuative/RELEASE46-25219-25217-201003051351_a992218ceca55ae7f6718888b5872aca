package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_732 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_732.procedure = onSearchInput;
         var_732.addEventListener(WindowKeyboardEvent.const_136,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_348.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_348.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_47.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_289,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_732.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
