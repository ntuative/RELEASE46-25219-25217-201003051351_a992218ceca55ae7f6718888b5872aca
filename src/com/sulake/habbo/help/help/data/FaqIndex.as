package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_692:FaqCategory;
      ...
      {
         super();
         var_692 = new FaqCategory(-999,"${help.faq.title.urgent}");
      ...
      {
         var _loc4_:* = null;
         if(var_692.hasItem(param1))
         {
            var_692.getItem(param1).answerText = param2;
         }
