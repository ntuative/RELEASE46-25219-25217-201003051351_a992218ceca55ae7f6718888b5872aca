package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2066:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25219-25217-201003051322");
         var_193 = param5;
         var_106 = new Map();
         var_106.add(HabboHelpViewEnum.const_1287,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_144,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_388,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_234,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_226,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_514,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_292,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_588,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_218,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_106.add(HabboHelpViewEnum.const_911,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_681,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_265 == HabboHelpViewEnum.const_144 || false)
         {
            return;
         }
         if(var_403 == null)
      ...
      {
         return var_106.getValue(var_265);
      }
      ...
      {
         var_2067 = param1;
         var _loc2_:IHelpViewController = var_106.getValue(HabboHelpViewEnum.const_144) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_935:
               showUI(HabboHelpViewEnum.const_911);
               break;
            case CallForHelpResultEnum.const_819:
      ...
      {
         var _loc3_:* = null;
         if(var_265 == HabboHelpViewEnum.const_144)
         {
            return;
         }
         if(true)
         {
            ...
            var_582.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_582[1],var_582[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_582[0],var_582[0].rect,new Point(0,0));
         }
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_265);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_193 != null)
            {
               var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_29.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_571));
      }
