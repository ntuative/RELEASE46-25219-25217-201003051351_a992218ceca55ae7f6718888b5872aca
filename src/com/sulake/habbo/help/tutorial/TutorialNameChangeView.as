package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_2056:uint = 11129827;
      ...
      private var var_853:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_49.localization.registerParameter("help.tutorial.name.available","name",var_401);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_ok":
                  ...
                  break;
               case "button_cancel":
                  var_49.showView(TutorialUI.const_83);
                  break;
               case "button_usecurrent":
                  var_401 = var_49.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_49.localization.registerParameter("help.tutorial.name.confirmation","name",var_401);
         }
         if(var_264 == null)
         {
            var_264 = var_49.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_264 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1583 || param1 == ChangeUserNameResultMessageEvent.var_1585)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_853 = new NameSuggestionListRenderer(var_49);
         var _loc6_:int = var_853.render(param3,_loc5_);
         var _loc7_:int = 0;
