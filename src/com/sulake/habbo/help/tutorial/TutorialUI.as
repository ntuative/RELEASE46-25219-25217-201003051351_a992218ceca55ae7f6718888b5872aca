package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_49 = param1;
         var_49.events.addEventListener(HabboHelpTutorialEvent.const_571,onTaskDoneEvent);
         var_49.events.addEventListener(HabboHelpTutorialEvent.const_582,onTaskDoneEvent);
         var_49.events.addEventListener(HabboHelpTutorialEvent.const_498,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         var_49.hideUI();
         var_49.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_99));
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_993 = param2;
         var_992 = param3;
         if(var_28 == null || var_28.id == const_83)
         {
            prepareForTutorial();
            showView(const_83);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_993 = true;
         if(var_28 != null && (var_28.id == const_236 || var_28.id == const_83))
         {
            showView(const_83);
         }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_571:
               var_992 = true;
               if(var_28 != null && var_28.id == const_417)
               {
                  showView(const_83);
               }
               break;
      ...
      {
         var_991 = true;
         if(var_28 != null && (var_28.id == const_325 || var_28.id == const_83))
         {
            showView(const_83);
         }
      }
      ...
      {
         return var_991 && var_993 && var_992;
      }
   }
}
