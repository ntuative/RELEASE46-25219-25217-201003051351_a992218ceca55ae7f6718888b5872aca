package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1272:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_825:String = "group_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1272:
               if(var_172 != null)
               {
                  _loc5_ = var_172.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_825:
               if(var_172 != null)
               {
                  if(var_172 != null)
                  {
                     _loc5_ = var_172.getKey("group.badge.url");
