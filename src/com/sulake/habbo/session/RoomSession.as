package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1025:UserDataManager;
      ...
      {
         if(var_32 == RoomSessionEvent.const_333 && _connection != null)
         {
            var_32 = RoomSessionEvent.const_92;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1025 as IUserDataManager;
      }
