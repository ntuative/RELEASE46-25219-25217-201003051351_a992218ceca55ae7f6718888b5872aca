package com.sulake.habbo.session.events
{
   ...
   public class RoomSessionQueueEvent extends RoomSessionEvent
   {
      ...
      public static const const_399:String = "RSQE_QUEUE_STATUS";
      
      public static const const_970:int = 2;
      
      public static const const_994:String = "c";
      
      public static const const_1367:String = "d";
      ...
      {
         super(const_399,param1,param5,param6);
         _name = param2;
         _target = param3;
         var_1149 = new Map();
         var_250 = param4;
