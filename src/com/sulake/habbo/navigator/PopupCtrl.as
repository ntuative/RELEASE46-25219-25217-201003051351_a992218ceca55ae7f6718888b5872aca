package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_344 = new Timer(500,1);
         var_302 = new Timer(100,1);
         super();
         _navigator = param1;
         var_1325 = param4;
         var_1672 = param2;
         _popupIndentLeft = param3;
         var_344.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_344)
         {
            var_344.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_344.reset();
            var_344 = null;
         }
         if(var_302)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_48 == null)
         {
            var_48 = IWindowContainer(_navigator.getXmlWindow(var_1325));
            var_48.visible = false;
         ...
         var_48.x = _loc2_.x + var_1672 + param1.width;
