package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1971 = new RoomThumbnailRenderer(param1);
         var_774 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_175,var_113.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_774.refreshTags(_loc1_,var_113.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1971.refreshThumbnail(_loc1_,var_113.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_175,var_113);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_175,!true ? getEventCtg(var_113.categoryId) : getRoomCtg(var_113.categoryId));
         refreshRoomDesc(var_175,var_113);
         refreshExtraCont();
         refreshInfo(var_175,"trading_allowed",var_113.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_185,Tabs.const_221,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
