package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_1132:IWindowContainer;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1132 != null)
         {
            _loc2_ = var_1132.tags[0];
            var_1132.color = getBgColor(_loc2_);
         }
         var_1132 = param1;
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(var_1668 - _loc2_.stageX);
         var_1668 = _loc2_.stageX;
         var_1667 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_170,null,0);
         ...
         var_760.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_127:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_170:
