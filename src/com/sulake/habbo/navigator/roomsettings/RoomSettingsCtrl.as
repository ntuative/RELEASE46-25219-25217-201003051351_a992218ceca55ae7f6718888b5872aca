package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1146:TextFieldManager;
      ...
      private var var_373:IRoomSettingsCtrlOwner;
      
      private var _inRoom:Boolean;
      
      private var var_1144:TextFieldManager;
      ...
      {
         close();
         this.var_373.roomSettingsRefreshNeeded();
      }
      ...
      private function populateForm() : void
      {
         ...
         var_1144.setText(_loc1_.description);
         var_960.setText("");
         var_1146.setText("");
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_373.roomSettingsRefreshNeeded();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_374);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_82.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_374]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_57,HabboWindowStyle.const_36,HabboWindowParam.const_66,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1405.visible = _inRoom;
         var_1406.visible = _inRoom;
         var_1708.visible = var_454;
         var_1707.visible = !var_454;
         if(var_454)
         {
            var_962.visible = true;
            var_1145.visible = false;
            refreshFlatControllers();
            var_962.height = Util.getLowestPoint(this.var_962) + 4;
         }
         else
         {
            populateForm();
            var_961.visible = true;
            var_1145.visible = true;
            var_1148.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1148.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_961.height = Util.getLowestPoint(this.var_961) + 4;
         }
         var_1407.text = !!var_454 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1405.name,var_1148.name,var_961.name,var_962.name,var_1145.name,var_1406.name],0,0);
      ...
      {
         this.var_374 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_374));
         if(var_964 != null)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1144.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_360;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_127)
         {
            _loc8_ = var_960.getText();
            _loc9_ = var_1146.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_960.clearErrors();
               this.var_1146.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = var_1147.isSelected;
         _loc2_.allowWalkThrough = var_1143.isSelected;
         _loc2_.tags = new Array();
         addTag(var_756,_loc2_.tags);
         addTag(var_757,_loc2_.tags);
         this.clearErrors();
         this.var_963 = _loc2_.roomId;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_374));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_374 || var_963 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_963 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1154)
         {
            this.var_775.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1187)
         {
            this.var_775.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1302)
         {
            this.var_1144.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1228)
         {
         ...
         {
            this.var_960.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_577,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_908,onDoorModePasswordUnselect);
         ...
         this.var_1144 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         ...
         this.var_960 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1146 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1142 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1147 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1143 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1405 = IWindowContainer(_window.findChildByName("header_container"));
         var_1148 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_961 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_962 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1406 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1145 = IWindowContainer(_window.findChildByName("footer_container"));
         var_246 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_964 = IWindowContainer(_window.findChildByName("password_container"));
         var_1707 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1708 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1407 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1407.procedure = onSwitchView;
         var_964.visible = false;
         if(!_inRoom)
         {
