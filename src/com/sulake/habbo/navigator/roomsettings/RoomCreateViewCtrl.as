package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_843:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_488 = new Timer(100);
         var_488.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_61 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1030 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1762 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_488)
         {
            var_488.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_488.reset();
            var_488 = null;
         }
      }
      ...
      private function refresh() : void
      {
         ...
         var_843 = var_61[0];
         if(var_1762 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_36,HabboWindowParam.const_66,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_843.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1246 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1246 = true;
            _loc3_.y = 1;
