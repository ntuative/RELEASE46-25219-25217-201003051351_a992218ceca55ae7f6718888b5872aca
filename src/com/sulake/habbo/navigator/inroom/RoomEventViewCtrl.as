package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_631:TextFieldManager;
      ...
      private var var_758:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_631.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_756.getText());
         addTag(_loc6_,var_757.getText());
      ...
      {
         var_758.visible = false;
         var_1388.visible = true;
         var_1649.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_631.setText(param1.eventDescription);
         var_756.setText(getTagFromEvent(param1,1));
         var_757.setText(getTagFromEvent(param1,2));
         var_1127.visible = false;
         var_1126.visible = true;
         var_1128.visible = true;
         var_1390.visible = false;
         var_1389.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1388 = IWindowContainer(find("event_type_disabled_cont"));
            var_1649 = ITextWindow(find("event_type_disabled_text"));
            var_1390 = ITextWindow(find("create_caption"));
            var_1389 = ITextWindow(find("edit_caption"));
            var_1127 = IButtonWindow(find("create_button"));
            var_1126 = IButtonWindow(find("edit_button"));
            var_1650 = IButtonWindow(find("cancel_button"));
            var_1128 = IButtonWindow(find("end_button"));
            var_758 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1127,onCreateButtonClick);
            Util.setProcDirectly(var_1126,onEditButtonClick);
            Util.setProcDirectly(var_1128,onEndButtonClick);
            Util.setProcDirectly(var_1650,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_631 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_756 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_757 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_631.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
