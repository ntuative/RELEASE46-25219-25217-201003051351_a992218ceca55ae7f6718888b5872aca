package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_849:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_387,0,0,_loc4_,var_1505,var_850,var_849));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2045 = int(_config.getKey("interstitial.interval","30000"));
         var_2046 = int(_config.getKey("interstitial.show.time","5000"));
         var_1503 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1264 = _loc2_.imageUrl;
         var_1505 = _loc2_.clickUrl;
         if(var_1264 != "" && var_1505 != "")
         {
            _loc3_ = var_1264;
            ...
            _loc4_ = new URLRequest(var_1264);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1265 = _loc2_.imageUrl;
         var_2047 = _loc2_.clickUrl;
         var_690 = getTimer();
         if(var_1265 != "")
         {
            _loc3_ = var_1265;
            ...
            var_228.start();
            _loc4_ = new URLRequest(var_1265);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_381,0,0,param1.bitmapData,var_2047));
            var_690 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_849 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1503 > 0 && var_1504 >= var_1503)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_690;
         if(_loc1_ > var_2045)
         {
            ++var_1504;
      ...
      {
         var_290 = param2 as IHabboCommunicationManager;
         if(var_290 == null)
         {
            return;
         }
         _connection = var_290.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_850 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
