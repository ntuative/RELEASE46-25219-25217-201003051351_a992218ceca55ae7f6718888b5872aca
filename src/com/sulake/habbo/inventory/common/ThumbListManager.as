package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_1021 = param5;
         var_837 = param6;
         var_220 = Math.floor(var_1021 / _thumbWidth);
         var_18 = new BitmapData(var_1021,var_837);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_18.height < var_837)
         {
            _loc12_ = new BitmapData(var_18.width,var_837);
      ...
      public function updateImageFromList() : void
      {
         ...
         var_18 = new BitmapData(Math.max(var_220 * _thumbWidth,var_1021),Math.max(var_479 * var_93,var_837),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_220 && var_18.height < _loc3_.y * var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_220 - 1),var_93);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_220 - 1),0,_thumbWidth,var_18.height);
         _loc2_.copyPixels(var_18,_loc4_,new Point(0,var_93),null,null,true);
         _loc4_ = new Rectangle(0,var_93,_thumbWidth * (var_220 - 1),0 - var_93);
