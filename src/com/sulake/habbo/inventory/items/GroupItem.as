package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1610:int = 13421772;
      ...
      private const const_1609:int = 8947848;
      ...
      private const const_1416:Number = 0.2;
      
      protected var var_1376:Boolean;
      
      private const const_1417:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_594)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1435));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1369);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1376 && getRecyclableCount() > 0)
            {
