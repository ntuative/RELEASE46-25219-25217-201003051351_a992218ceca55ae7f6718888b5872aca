package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1068:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_201,onObjectPlaced);
         var_475 = new Timer(const_1068,1);
      ...
      {
         return var_10.getSubCategoryViewId() == InventorySubCategory.const_267;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_393.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_393.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_594)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_201,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_130 != null)
            {
               var_130.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_130.stop();
               var_130 = null;
            }
            if(var_662 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_662 == null)
         {
            var_662 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_662.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_267:
               ...
               break;
            case InventorySubCategory.const_836:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_130 = new Timer(param1,1);
            var_130.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_130.start();
         }
         else
         {
      ...
      {
         var_10.checkCategoryInitilization(InventoryCategory.const_463);
         ...
         if(param1 == InventoryCategory.const_71 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_41:
                  ...
                  break;
               case const_278:
                  var_10.toggleInventoryPage(InventoryCategory.const_155);
            }
         }
      }
      ...
      {
         if(var_826 && param1.type == RoomEngineObjectEvent.const_201)
         {
            var_10.showView();
            var_826 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_312 || _loc3_.category == FurniCategory.const_309 || _loc3_.category == FurniCategory.const_311)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_393.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_393 = new Map();
         var_393.add(const_40,new Array());
         var_393.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
