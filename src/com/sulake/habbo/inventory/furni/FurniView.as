package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_728:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_491 = new Map();
         var_491.add(FurniModel.const_40,new FurniGridView(_model,FurniModel.const_40,_windowManager,_assetLibrary,_roomEngine));
         var_491.add(FurniModel.const_41,new FurniGridView(_model,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_491.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_491.getValue(var_492);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_491.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_492);
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_728 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_491.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
