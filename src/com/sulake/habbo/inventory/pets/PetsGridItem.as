package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_47:
               var_999.setSelectedGridItem(this);
               var_815 = true;
               break;
            case WindowMouseEvent.const_87:
               var_815 = false;
               break;
            case WindowMouseEvent.const_27:
               ...
               {
                  var_815 = false;
                  var_999.placePetToRoom(var_1353.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1609) : uint(const_1610);
      }
