package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1512,var_1511);
         }
      }
      ...
      {
         if(param1 != var_2060 || param2 != var_2061)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1791);
      }
      ...
      {
         if(var_10 != null && false && var_212 != null)
         {
            var_10.furniModel.removeLockFrom(var_212.id);
            var_212 = null;
         }
      }
