package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         ...
         var_23.addHabboConnectionMessageEvent(new TradingOpenEvent(method_7,TradingOpenParser));
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_71,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_548);
         _loc2_.refreshViews();
         var_8.notifyChangedEffects();
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_155);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_8.setInventoryCategoryInit(InventoryCategory.const_335);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_71);
      ...
      private function method_7(param1:IMessageEvent) : void
      {
         ...
         var_8.toggleInventorySubPage(InventorySubCategory.const_267);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_463);
         var _loc4_:FurniModel = var_8.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
