package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1035:String = AvatarSetType.const_37;
      
      private static const const_1036:String = "Default";
      
      private static const const_1033:int = 125;
      ...
      private var var_440:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         var_122 = new AvatarImageCache(var_69,this,_assets,var_184);
         setDirection(const_1035,const_1034);
         var_185 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1115;
         if(param2 < AvatarDirectionAngle.const_1151)
         {
         ...
         if(var_684 == AvatarType.PET && param1 == AvatarSetType.const_46)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_69.sortActions(var_185);
         if(_loc1_ == null)
         {
            var_533 = new Array(0,0,0);
         }
         else
         {
            var_533 = var_69.getCanvasOffsets(_loc1_,var_184,var_91);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1115 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_440 = _loc3_.avatarData;
                  }
               }
            }
      ...
      {
         return var_69.getPartColor(var_532,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_69.getCanvas(var_184,var_165.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_69.getBodyParts(param1,var_165.definition,var_91);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_684 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_69.getParts(_loc9_,var_532,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_184 == AvatarScaleType.const_95)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_69.getPartActionOffset(getSubType(),var_184,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_69.getCanvas(var_184,var_165.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_69.getBodyParts(param1,var_165.definition,var_91);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(var_684 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_69.getParts(_loc7_,var_532,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_441);
                     _loc19_ = var_91;
                     _loc20_ = 1;
                     switch(var_91)
                     {
                     ...
                     _loc21_ = var_69.getPartActionOffset(getSubType(),var_184,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_440 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_440.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_165 = new ActiveActionData(AvatarAction.const_798);
         var_165.definition = var_69.getActionDefinition(const_1036);
      ...
      {
         return var_69.getBodyPartData(param1.animation.id,var_441,param1.id);
      }
