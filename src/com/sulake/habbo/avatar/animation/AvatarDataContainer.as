package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2172:uint;
      
      private var _rgb:uint;
      
      private var var_1069:Map;
      
      private var var_1411:Number = 1;
      
      private var _b:uint;
      
      private var var_1409:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1412,var_1409,var_1411,_alphaMultiplier);
         var_1069 = generatePaletteMapForGrayscale(var_2174,var_2172);
      }
      
      public function get reds() : Array
      {
         return var_1069.getValue("reds") as Array;
      }
      ...
      {
         return var_1069.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1069.getValue("greens") as Array;
      }
      ...
      {
         return var_1069.getValue("alphas") as Array;
      }
