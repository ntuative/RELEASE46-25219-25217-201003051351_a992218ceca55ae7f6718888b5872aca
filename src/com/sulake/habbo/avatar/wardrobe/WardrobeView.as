package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_636:IItemListWindow;
      
      private var var_542:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_636 = _window.findChildByName("mylooks") as IItemListWindow;
         var_542 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_779 = _window.findChildByName("selector") as IItemListWindow;
         var_1413 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  _model.controller.catalog.openCatalogPage(CatalogPageName.const_259,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _model.selectMyLook(var_636.getListItemIndex(param2.parent));
         }
      }
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in _model.hotLooks)
         {
            ...
            {
               var_542.addListItem(_loc3_.view.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_636.removeListItemAt(0);
            }
            for each(_loc2_ in _model.myLooks)
            {
               var_636.addListItem(_loc2_.view.window);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_780 * 8 + var_542.getListItemIndex(param2.parent);
