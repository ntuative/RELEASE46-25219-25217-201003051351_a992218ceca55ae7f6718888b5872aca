package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_934:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_1927:IStructureData;
      
      private var var_1465:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1465 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_1927.append(var_1465);
         dispatchEvent(new Event(AvatarStructureDownload.const_934));
      }
   }
}
