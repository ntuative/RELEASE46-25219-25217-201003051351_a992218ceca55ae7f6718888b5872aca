package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_796:IAvatarImage;
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_122.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_122.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_641)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_397)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_69.getParts(param1,(var_796 as AvatarImage).getFigure(),_loc6_,var_1123,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_69.getCanvas(var_184,var_1123);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1321[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_933 || _loc32_ == AvatarAction.const_587) && (_loc6_ == AvatarBodyPartType.const_305 || _loc6_ == AvatarBodyPartType.const_1179 || _loc6_ == AvatarBodyPartType.const_1329) && _loc7_.color != null)
               {
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_122 != null)
         {
            _loc2_ = var_122.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_122.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
