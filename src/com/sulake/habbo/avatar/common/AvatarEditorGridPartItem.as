package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1610:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_933:BitmapData;
      
      private const const_1609:int = 13421772;
      
      private var var_847:Rectangle;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         var_933 = _loc6_.content as BitmapData;
         if(param3 == null)
         {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1493 = Math.max(var_1493,_loc7_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(var_576 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_933,var_933.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1609;
         }
         else
         {
            _window.color = const_1610;
         }
         _window.invalidate();
      }
      ...
      private function analyzeLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_989 + "_" + FigureData.const_255;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_847.width,var_847.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_989 + "_" + FigureData.const_255;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1492 && _loc2_.colorLayerIndex > 0)
               {
