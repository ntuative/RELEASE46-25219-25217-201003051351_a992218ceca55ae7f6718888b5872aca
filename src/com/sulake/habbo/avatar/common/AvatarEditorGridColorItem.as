package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_621:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_747.width,var_747.height,true,0);
            _loc4_ = var_747.clone();
            _loc4_.colorTransform(_loc4_.rect,var_621.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_622.width,var_622.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_622,var_622.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(false)
               {
                  _loc5_.bitmap.copyPixels(var_933,var_933.rect,new Point(0,0),null,null,true);
               }
               else
               {
                  _loc5_.bitmap.copyPixels(var_934,var_934.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }
