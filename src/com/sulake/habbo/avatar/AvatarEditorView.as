package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1584:IWindowContainer;
      ...
      private var var_1486:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1584 == null)
         {
            ...
            var_1584 = var_10.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
      ...
      private function createWindow() : void
      {
         ...
         var_1486 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_683 != null)
         {
            toggleCategoryView(var_683,true);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_683 = param1;
         var_1486.setSelected(var_1486.getSelectableByName(param1));
         _window.invalidate();
      }
