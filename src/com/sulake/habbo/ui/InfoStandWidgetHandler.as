package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_108,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_108,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_541);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_303);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_897);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_279)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_925)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_543);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_194)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_558);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1359;
                  if(!_loc25_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1212);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_558);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_286);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_505);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_590);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1226);
         _loc1_.push(RoomWidgetPetCommandMessage.const_673);
         _loc1_.push(RoomWidgetPetCommandMessage.const_665);
         _loc1_.push(RoomWidgetUserActionMessage.const_688);
         _loc1_.push(RoomWidgetUserActionMessage.const_362);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_426)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_286:
            ...
            case RoomWidgetUserActionMessage.const_730:
               ...
               break;
            case RoomWidgetUserActionMessage.const_688:
               _container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_622:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_877,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_735:
               ...
               break;
            case RoomWidgetUserActionMessage.const_505:
            ...
            case RoomWidgetUserActionMessage.const_679:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_665:
               _loc12_ = param1 as RoomWidgetPetCommandMessage;
               _container.roomSession.method_9(_loc12_.petId);
               break;
            case RoomWidgetPetCommandMessage.const_673:
