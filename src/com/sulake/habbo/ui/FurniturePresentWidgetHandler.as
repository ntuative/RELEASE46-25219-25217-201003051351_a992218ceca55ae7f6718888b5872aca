package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetPresentDataUpdateEvent = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_76,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_716,RoomWidgetPresentOpenMessage.const_678,RoomWidgetPresentOpenedMessage.const_1242];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_78:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_466,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           ...
                           else
                           {
                              ...
                              if(_loc4_ != null)
                              {
                                 _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_76,0,_name,false,_loc4_.data);
                              }
                           }
                           break;
                        case ProductTypeEnum.const_407:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_412,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_716:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_149 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_148);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_678:
