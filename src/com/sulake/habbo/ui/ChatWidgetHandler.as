package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_834:Number = 0;
      
      private var var_476:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_477.length)
            {
               _loc2_ = var_477.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_477.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_671.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_279:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_477.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_671.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_645,RoomWidgetChatSelectAvatarMessage.const_660];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_645:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_146,_container.roomSession,0,"Version 25219-25217-201003051322");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_660:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_834 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_834);
            }
            if(var_476 == null)
            {
               var_478.x = 0;
               var_478.y = 0;
               var_478.z = 0;
               var_476 = _loc4_.getScreenPoint(var_478);
               var_834 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_478.x = 0;
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_476.x || _loc8_.y != var_476.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_476,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_316;
      }
