   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_734,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_393,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_734,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_907,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_947,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_393,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_99:
               ...
               break;
            case HabboHelpTutorialEvent.const_393:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_359));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_617);
         _loc1_.push(RoomWidgetDanceMessage.const_559);
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_525);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_633);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_503);
         ...
         _loc1_.push(RoomWidgetToolbarMessage.const_649);
         _loc1_.push(RoomWidgetToolbarMessage.const_584);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_646);
         ...
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_501);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_547);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_690);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1355);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_637);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_642));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_501:
               ...
               break;
            case RoomWidgetWaveMessage.const_617:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_559:
               if(_container != null && false)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_666:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_503:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_643)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_259,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_633:
               ...
               if(var_8 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_955:
                        _catalog.openCatalogPage(CatalogPageName.const_1289,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_796:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_525:
            case RoomWidgetStopEffectMessage.const_670:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_927:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_683:
               ...
               break;
            case RoomWidgetToolbarMessage.const_649:
               ...
               if(var_193)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_584:
               ...
               if(var_193 && false)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_370,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_646:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == 0)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_403,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_826));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_403,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1366));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_582));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_547:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_690:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_299,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_637:
            ...
            case RoomWidgetAvatarEditorMessage.const_721:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_498));
               }
               break;
            default:
