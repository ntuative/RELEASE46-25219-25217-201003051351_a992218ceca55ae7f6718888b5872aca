package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_835:IHabboHelp = null;
      ...
      private var var_836:IRoomWidgetFactory = null;
      ...
      private var var_176:IToolTipWindow;
      
      private var var_354:ISessionDataManager = null;
      
      private var var_2009:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_691,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_686 = _roomEngine.loadRoomResources(var_37.roomResources);
            if(false)
            {
               var_1255 = false;
         ...
         {
            var_1256 = !_adManager.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_37.roomId,var_37.roomCategory,var_260[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_242,processEvent);
         }
         _friendList = null;
         var_177.dispose();
         var_177 = null;
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_691,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_17 = null;
         var_836 = null;
         ...
         if(var_193 && false)
         {
            ...
            var_193.events.removeEventListener(HabboToolbarEvent.const_55,onHabboToolbarEvent);
         }
         var_193 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2009);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_193 != null)
         {
            var_177.toolbarSize = var_193.size;
            var_177.toolbarOrientation = var_193.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_176 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_176.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_836.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_532:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_320,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_672 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
            ...
            case RoomEngineObjectEvent.const_449:
               ...
               break;
            case RoomEngineObjectEvent.const_636:
               if(true)
               {
                  return;
               }
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_692);
            _loc13_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_599);
            _loc14_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_698);
            _loc15_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_629);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_475:
               ...
               var_176 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_294,WindowStyle.const_330,WindowParam.const_79) as IToolTipWindow;
               var_176.setParamFlag(WindowParam.const_48,false);
      ...
      {
         if(var_686 == null || false)
         {
            return;
         }
         var _loc2_:int = var_686.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_686.splice(_loc2_,1);
         }
         if(false)
         {
            var_1255 = true;
      ...
      {
         if(var_17 != null && var_37 != null && var_1256 && var_1255)
         {
            var_17.startSession(var_37);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_268));
         }
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_242,processEvent);
         }
      }
