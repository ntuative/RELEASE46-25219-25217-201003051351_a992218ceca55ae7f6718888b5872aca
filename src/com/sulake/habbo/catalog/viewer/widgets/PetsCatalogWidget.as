package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var breed:IBreed = var_555[var_1459] as IBreed;
      ...
      override public function init() : void
      {
         ...
         events.addEventListener(WidgetEvent.const_1010,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         var _loc3_:IBreed = var_555[var_1459] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_824,_loc3_.id,_loc2_,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_287,AvatarAction.const_586);
