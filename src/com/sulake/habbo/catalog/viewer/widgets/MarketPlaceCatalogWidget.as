package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_806:MarketPlaceOfferData;
      
      private const const_1403:int = 1;
      
      private const const_1605:int = 40;
      ...
      private const const_1606:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_467)
         {
            ...
            var_467 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_467)
         {
            return;
         ...
         if(!var_378)
         {
            var_378 = new Timer(25);
            var_378.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_805 = 0;
         populateList();
         var_378.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_467 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_467.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_377.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_378)
         {
            var_378.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_378 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_805 >= var_551.length)
            {
               return true;
            }
            addListItem(var_551.getWithIndex(var_805));
            ++var_805;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_806.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_377));
            _loc7_.selection = 0;
         }
      }
