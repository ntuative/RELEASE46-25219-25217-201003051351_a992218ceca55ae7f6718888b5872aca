package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1080 != null)
         {
            var_1080.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1079 != null)
         {
            var_1079.removeEventListener(WindowKeyboardEvent.const_136,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1080 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1080 != null)
         {
            var_1080.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1079 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1079 != null)
         {
            var_1079.addEventListener(WindowKeyboardEvent.const_136,windowKeyEventProcessor);
         }
      }
