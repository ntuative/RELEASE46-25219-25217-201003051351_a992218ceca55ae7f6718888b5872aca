package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_573:IItemGridWindow;
      
      private var var_87:IBitmapWrapperWindow;
      
      private var var_1343:ITextWindow;
      
      private var var_1247:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_573 != null)
         {
            var_573.visible = false;
            var_573.destroyGridItems();
         }
         if(var_1247 != null)
         {
            var_1247.visible = false;
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_382:
                  _loc4_ = var_1248.clone();
                  if(var_573 != null)
                  {
                     var_573.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_573,var_1247,var_1361);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_220:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_287,AvatarAction.const_524);
                              _loc13_.appendAction(AvatarAction.const_723,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1483 = new Point(var_87.x,var_87.y);
         var_573 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1247 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_573 == null)
         {
         ...
         var_1248 = _loc2_.content as BitmapData;
