package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1609:XML;
      
      private var var_303:IGridItem;
      
      private var var_1361:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_751:PrizeViewer;
      ...
      override public function init() : void
      {
         ...
         var_1609 = _loc1_.content as XML;
         populateItemGrid();
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1609) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1361) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_751.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
