package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1563)
         {
            case RecyclerStatusMessageEvent.const_1284:
               ...
               break;
            case RecyclerStatusMessageEvent.const_939:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1563 != RecyclerStatusMessageEvent.const_939;
      }
      
      private function get statusActive() : Boolean
      {
         return var_279 != const_783;
      }
      ...
      {
         return active && var_279 == const_346;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_846:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1307:
