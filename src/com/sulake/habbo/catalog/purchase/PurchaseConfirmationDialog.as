package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_659,var_80,var_1042);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_584[var_197]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_585[var_196]);
         _catalog.purchaseProductAsGift(var_659,var_80,var_1042,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_47:
               ...
               break;
            case WindowKeyboardEvent.const_659:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_500 == null)
         {
            var_500 = createWindow("suggestion_list_item") as IWindowContainer;
            var_500.procedure = suggestionsEventHandler;
         }
         if(var_231 == null || var_500 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_231.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_500.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
