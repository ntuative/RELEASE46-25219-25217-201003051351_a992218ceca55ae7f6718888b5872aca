package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_746:uint = 11;
      ...
      private var var_379:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_989:int = -1;
      
      private var var_1184:LagWarningLogger = null;
      
      private var var_807:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1184 = new LagWarningLogger();
         var_1183 = new Array(const_746);
         var _loc4_:int = 0;
         while(_loc4_ < const_746)
         {
            var_1183[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1255,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1166,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_611,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_844,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_664:
               trackLoginStep(HabboLoginTrackingStep.const_1188,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_222:
               trackLoginStep(HabboLoginTrackingStep.const_222);
               break;
            ...
            case HabboCommunicationEvent.const_196:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_196);
               if(var_215 != null)
               {
                  var_215.init();
               }
      ...
      {
         var_172 = IHabboConfigurationManager(param2);
         if(var_172)
         {
            Component(var_172).events.addEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
            if(var_215 != null)
            {
               var_215.configuration = var_172;
            }
            if(var_216 != null)
            {
               var_216.configuration = var_172;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_387,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_844,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_611,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_664,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_222,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_196,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_672,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_406:
               var_1184.registerWarning(LagWarningLogger.const_891);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_807)
            {
               var_807.release(new IIDHabboWindowManager());
               var_807 = null;
            }
            if(_adManager)
            {
            ...
            if(var_173)
            {
               if(true)
               {
                  ...
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.const_314,onFriendlistTrackingEvent);
               }
            ...
            if(var_379)
            {
               if(true)
               {
                  var_379.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_379.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_379.release(new IIDHabboHelp());
               var_379 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_406,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_172)
         {
            Component(var_172).events.removeEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
         }
      }
      ...
      {
         var_379 = param2 as IHabboHelp;
         var_379.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_379.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_980);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_980,onCoreRunning);
         }
      }
      ...
      {
         var_807 = IHabboWindowManager(param2);
         if(var_807)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_989 > -1 && _loc2_ < var_989)
         {
            ++var_1443;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1443);
         }
         if(var_989 > -1 && _loc2_ - var_989 > 15000)
         {
            ++var_1444;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1444);
         }
         var_989 = _loc2_;
         if(var_216 != null)
         {
         ...
         if(var_1184 != null)
         {
            var_1184.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_172 != null && Boolean(var_172.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_406,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.const_314,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_172)
            {
               if(var_172.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_172.getKey("client.fatal.error.url");
