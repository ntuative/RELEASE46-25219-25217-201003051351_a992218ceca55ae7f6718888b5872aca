package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1066:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_422 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_1066 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_422.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_117.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1066.load(_loc4_,var_117.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_58.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_58,WindowTracker.const_854,_loc2_),_window,false,false,true);
      }
