package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1416:IMessageComposer;
      ...
      {
         var_901 = IWindowContainer(var_49.getXmlWindow("chatlog_roomheader"));
         var_900 = IWindowContainer(var_49.getXmlWindow("chatlog_chatline"));
         ...
         var_49.connection.send(var_1416);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_901.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_900.clone());
         _loc4_.color = var_1332[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
