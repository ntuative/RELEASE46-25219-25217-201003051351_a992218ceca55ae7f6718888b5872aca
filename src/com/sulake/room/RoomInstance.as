package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_132:IRoomRendererBase;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(var_132)
               {
                  var_132.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_132)
                  {
                     var_132.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
