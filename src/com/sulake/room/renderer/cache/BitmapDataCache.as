   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               var_510 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         var_510 += param2.width * param2.height * 4;
      }
      ...
      public function compress() : void
      {
         ...
         {
            var_353.sortOn("useCount",0 | 0);
            _loc2_ = -1;
            while(_loc2_ >= 0)
            {
               _loc1_ = var_353[_loc2_] as BitmapDataCacheItem;
            ...
            var_353.splice(_loc2_,0 - _loc2_);
            if(memUsage > memLimit)
            {
               var_353.sortOn("memUsage",Array.NUMERIC);
               while(memUsage > memLimit)
               {
                  _loc1_ = var_353.pop() as BitmapDataCacheItem;
                  if(_loc1_ == null)
                  {
                     break;
                  }
