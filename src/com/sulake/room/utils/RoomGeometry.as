package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_787:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1551 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_419 != param1 * var_1551)
         {
            var_419 = param1 * var_1551;
            ++var_78;
         }
      }
      ...
      {
         if(var_420 != param1 * var_1552)
         {
            var_420 = param1 * var_1552;
            ++var_78;
         }
      }
      ...
      {
         if(var_418 != param1 * var_1550)
         {
            var_418 = param1 * var_1550;
            ++var_78;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_421 != null)
         {
            ...
            var_421.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_421.add(_loc3_,_loc4_);
            ++var_78;
         }
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2342 || _loc3_ > var_2343)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_420,0 * var_418,0 * var_419);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_421 != null)
         {
            ...
            return var_421.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_420,0 * var_418,0 * var_419);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_85;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_420,param2.y * var_418,param2.z * var_419);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_420,param3.y * var_418,param3.z * var_419);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_420,param4.y * var_418,param4.z * var_419);
