package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private static var var_1125:int = 0;
      ...
      private var var_386:IRoomObjectEventHandler;
      
      private var var_1453:Vector3d;
      
      private var _instanceId:int = 0;
      
      private var _id:int;
      
      private var var_1454:Vector3d;
      ...
      public function RoomObject(param1:int, param2:int)
      {
         ...
         var_1453 = new Vector3d();
         var_1454 = new Vector3d();
      ...
      {
         var_1454.assign(var_238);
         return var_1454;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_473.length)
         {
      ...
      public function setEventHandler(param1:IRoomObjectEventHandler) : void
      {
         ...
         var _loc2_:IRoomObjectEventHandler = var_386;
         if(_loc2_ != null)
         {
            var_386 = null;
            _loc2_.object = null;
      ...
      {
         if(param1 >= 0 && param1 < var_473.length)
         {
